...
@Component({
  selector: 'app-frocks',
  templateUrl: './frocks.component.html',
  styleUrls: ['./frocks.component.scss']
})
export class FrocksComponent implements OnInit {
...
return this.siteData.filter(p =>p.subcategory=='frocks');
