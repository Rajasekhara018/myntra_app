...
@Component({
  selector: 'app-jeens',
  templateUrl: './jeens.component.html',
  styleUrls: ['./jeens.component.scss']
})
export class JeensComponent implements OnInit {
...
return this.siteData.filter(p =>p.subcategory=='jeens');
