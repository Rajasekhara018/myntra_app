...
@Component({
  selector: 'app-schoolshoe',
  templateUrl: './schoolshoe.component.html',
  styleUrls: ['./schoolshoe.component.scss']
})
export class SchoolshoeComponent implements OnInit {
...
return this.siteData.filter(p =>p.subcategory=='schoolshoe');
